...
; Create GUI
$GameScheduleGui = GUICreate("Game Schedule", 950, 510)
...
_GUICtrlListView_AddColumn($hListView_Right, "מחזור", 43)
_GUICtrlListView_AddColumn($hListView_Right, "תאריך", 83);add column
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 1", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 2", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 3", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 4", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 5", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 6", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 7", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 8", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 9", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 10", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 11", 63)
_GUICtrlListView_AddColumn($hListView_Right, "מסלול 12", 63)
