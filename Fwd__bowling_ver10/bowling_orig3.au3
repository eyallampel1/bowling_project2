...
$Form1_1 = GUICreate("Ahsdod Bowling", 1126, 648, 259, 113)
...
$RoundNumberInput = GUICtrlCreateInput("", 870, 25, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
...
$Player1_score_game1_1 = GUICtrlCreateInput("", 536, 127, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player1_score_game2_1 = GUICtrlCreateInput("", 483, 127, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player1_score_game3_1 = GUICtrlCreateInput("", 430, 127, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player2_score_game1_1 = GUICtrlCreateInput("", 536, 157, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player2_score_game2_1 = GUICtrlCreateInput("", 483, 157, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player2_score_game3_1 = GUICtrlCreateInput("", 430, 157, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player3_score_game1_1 = GUICtrlCreateInput("", 536, 187, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player3_score_game2_1 = GUICtrlCreateInput("", 483, 187, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player3_score_game3_1 = GUICtrlCreateInput("", 430, 187, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
...
$HandicapPlayer1_1 = GUICtrlCreateInput("", 377, 127, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$HandicapPlayer2_1 = GUICtrlCreateInput("", 377, 157, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$HandicapPlayer3_1 = GUICtrlCreateInput("", 377, 187, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))

$HandicapPlayer1_2 = GUICtrlCreateInput("", 380, 386, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$HandicapPlayer2_2 = GUICtrlCreateInput("", 380, 416, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$HandicapPlayer3_2 = GUICtrlCreateInput("", 380, 446, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
...
$ScoreTeam1 = GUICtrlCreateInput("", 187, 225, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER,$ES_READONLY))
$TeamPlayer1Name_1 = GUICtrlCreateInput("", 613, 127, 153, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER,$ES_READONLY))
$Label2 = GUICtrlCreateLabel("Game 2", 486, 103, 43, 17)
...
$TeamPlayer2Name_1 = GUICtrlCreateInput("", 613, 157, 153, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER,$ES_READONLY))
$TeamPlayer3Name_1 = GUICtrlCreateInput("", 613, 187, 153, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER,$ES_READONLY))
$Label8 = GUICtrlCreateLabel("Handicap", 378, 103, 51, 17)

$Label11 = GUICtrlCreateLabel("Team Number", 429, 42, 75, 17)
$TeamNumber_1_inputbox = GUICtrlCreateInput("", 437, 66, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER,$ES_READONLY))
$Label14 = GUICtrlCreateLabel("Score", 240, 230, 28, 17)
$Label1 = GUICtrlCreateLabel("Player AVG", 318, 103, 59, 17)
$Player1_AVG_1 = GUICtrlCreateInput("", 324, 127, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player2_AVG_1 = GUICtrlCreateInput("", 324, 157, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
$Player3_AVG_1 = GUICtrlCreateInput("", 324, 187, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
GUICtrlCreateGroup("", -99, -99, 1, 1)
