...
;readFromTextFile()
Global $NextIndex=0
Global $DO_YOU_WANT_TO_CALCULATE_SCORE=1
...
Func RoundNumberInput_function()
	...
	If  ((GUICtrlRead( $RoundNumberInput)="1") And ($NextIndex=0)) Then
...
MsgBox(0,"Entering haslama mode!","the system will not recalculate players score until you will write H again!!!")
$DO_YOU_WANT_TO_CALCULATE_SCORE=0
GUICtrlSetData($nID,"")
EndIf
...
Func calculateScore()
	...
	If $DO_YOU_WANT_TO_CALCULATE_SCORE=1 Then

;InputBox ( "title", "prompt")
$ScoreTeam1_func=0
$ScoreTeam2_func=0
;$DO_YOU_WANT_TO_CALCULATE_SCORE=1


;If StringLen( GUICtrlRead($Player1_score_game1_1))>3 Then
;MsgBox(0,"THIS IS AN HASLAMA","THIS IS AN HASLAMA- DONT RECALCULATE!"
;EndIf
